    ...
    <div className="grid gap-5 lg:grid-cols-2">
      <div className="overflow-hidden rounded-sm border border-navy-900/15 bg-[#fffdf8]">
        <div className="border-b border-zinc-100 bg-zinc-50/80 px-6 py-5 md:px-8">
          ...
          <h3 className="mt-1 text-2xl font-bold text-ink">Primarily campus resources.</h3>
        </div>
        <ul className="px-6 py-2 md:px-8">
          {collegeContribution.map((row) => (
            ...
            >
              ...
              <span className="shrink-0 border border-navy-900/10 px-2.5 py-0.5 text-xs font-medium text-zinc-500">
                {row.source}
              </span>
            </li>
          ))}
      ...
      <div className="overflow-hidden rounded-sm border border-zinc-800 bg-ink text-white">
        <div className="border-b border-white/10 px-6 py-5 md:px-8">
          <p className="text-[11px] font-semibold tracking-wide text-brand-orange uppercase">
            Institutional return
          </p>
          <h3 className="mt-1 text-2xl font-bold">Defined program deliverables.</h3>
        </div>
        <ul className="px-6 py-2 md:px-8">
