...
export function EventDirectory() {
  ...
  return <div className="min-h-[70vh] bg-[#f7f4ed] py-14 sm:py-20"><div className="container-page"><div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end"><div className="max-w-2xl"><p className="eyebrow">Campus calendar · 2026</p><h1 className="mt-5 font-heading text-4xl font-extrabold tracking-tight text-ink sm:text-6xl">Find something<br/><span className="text-brand-orange">worth attending.</span></h1></div><p className="max-w-md text-sm leading-relaxed text-zinc-600">Browse verified college festivals, workshops, hackathons, competitions and cultural programmes.</p></div>
