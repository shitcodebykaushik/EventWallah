...
export function CollegeDirectory() {
  ...
  return <div className="min-h-[70vh] bg-[#f7f4ed] py-14 sm:py-20"><div className="container-page">
    <div className="max-w-3xl"><p className="eyebrow">Institution directory</p><h1 className="mt-5 font-heading text-4xl font-extrabold tracking-tight text-ink sm:text-6xl">Find your college.<br/><span className="text-zinc-400">See what is happening.</span></h1><p className="mt-5 text-zinc-600">Search participating colleges and universities across India. More institutions are added as their event teams join EventWallah.</p></div>
